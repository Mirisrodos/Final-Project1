...
$('.events').append("<li>after event fired.</li>");
        ...
        <div class="about-team"> 
            <div class="container">
                ...
                <div class="team-agileitsinfo" style="margin-left: 25%; width: 100%">
                    <div class="col-md-3 about-team-grids">
                        <img src="images/phs.jpg" alt=""/>
                        <div class="team-w3lstext">
                            <h4><span>Phan Hồng Sơn</span></h4>
                            <p>Sinh viên Trường Đại học Sư Phạm Kỹ Thuật TP.Hồ Chí Minh</p>
                            <p>Khoa Đào tạo Chất lượng cao Ngành CNTT</p>
                        </div>
                    ...
                    <div class="col-md-3 about-team-grids">
                        <img src="images/TTHjpg.jpg" alt=""/>
                        <div class="team-w3lstext">                         
                            <h4><span>Trương Thuận Hòa</span></h4>
                            <p>Sinh viên Trường Đại học Sư Phạm Kỹ Thuật TP.Hồ Chí Minh</p>
                            <p>Khoa Đào tạo Chất lượng cao Ngành CNTT</p>
                        </div>
                        <div class="social-icons caption"> 
